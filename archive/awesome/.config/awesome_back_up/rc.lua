...
user = {
    ...
    dirs = {
        ...
        -- arealacritty -e sh -c sleep .1; neovim alacritty -e sh -c sleep .1; neovimnalacritty -e sh -c sleep .1; neovimoalacritty -e sh -c sleep .1; neovimt lost
    ...
    lock_screen_custom_password = "2awesome",
    ...
    openweathermap_key = "d66fb34ab7ea644282d2b909bcbc8b49",
