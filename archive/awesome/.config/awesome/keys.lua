...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ modkey,}, "d", function()
                awful.spawn.with_shell("rofi -show drun -config ~/Dotfiles/rofi/.config/rofi/config.rasi")
              end,
              {description = "open rofi", group = "awesome"}),
    awful.key({ modkey,}, "y", function()
                awful.spawn.with_shell("~/.config/awesome/scripts/youtube_rofi")
              end,
              {description = "open rofi", group = "awesome"}),
